...
orderA = recipeA.orders.create!(id:  1,order: 10, report_id: 1)
orderB = recipeB.orders.create!(id:  2,order: 12, report_id: 2)
orderC = recipeC.orders.create!(id:  3,order: 9, report_id:  3)
orderD = recipeD.orders.create!(id:  4,order: 8, report_id:  4)
orderE = recipeE.orders.create!(id:  5,order: 13, report_id: 5)
orderF = recipeF.orders.create!(id:  6,order: 6, report_id:  6)
orderG = recipeG.orders.create!(id:  7,order: 4, report_id:  7)
orderH = recipeH.orders.create!(id:  8,order: 7, report_id:  8)
orderI = recipeI.orders.create!(id:  9,order: 3, report_id:  9)
